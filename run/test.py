...
if __name__ == '__main__':
    ...
    if args.model == 'BaseParser':
        ...
        args_baseline_path = '../../pretrained/compact95.62/model'
        args_pretrained_LSTMs = '../../pretrained/params95.62'
        parser.initialize(args_baseline_path, args_pretrained_LSTMs)
